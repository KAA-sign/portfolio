$(document).ready(function() {
	...
	Backstretch Images
	==============================================*/
	$.backstretch('https://s3-eu-west-1.amazonaws.com/glynjackson/assets/header-bg.jpg');

	$('body').append('<img class="preload-image" src="https://s3-eu-west-1.amazonaws.com/glynjackson/assets/contact-bg.jpg" style="display:none;"/>');
	...
	$('#about').waypoint(function(direction){
		...
		if (direction=='down'){
			$.backstretch('https://s3-eu-west-1.amazonaws.com/glynjackson/assets/contact-bg.jpg');
		}else{
			$.backstretch('https://s3-eu-west-1.amazonaws.com/glynjackson/assets/header-bg.jpg');
		}
	});
